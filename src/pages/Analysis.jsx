    ...
    <div className="analysis_main">
      ...
      <div className="an_body">
        ...
        <div className="an_scBody">
          ...
          <div className="an_scElement">
            <Dropdown
              availability={selectedGP ? true : false}
              label={sessionLabel}
        ...
        <div className="an_fetchButton"><button className={selectedSession ? "an_scFetchButton active" : "an_scFetchButton"}>Fetch Session Data</button></div>
        <div></div>
      </div>
    </div>
  );
